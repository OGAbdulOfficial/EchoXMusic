...
<div align="center">
  <table>
    <tr>
      ...
      <td>
        <img src="https://readme-typing-svg.herokuapp.com?color=00BFFF&width=600&lines=Hey+There,+This+is+EchoX+Network+%F0%9F%A5%80+%E2%9D%97%EF%B8%8F" />
      </td>
    </tr>
  </table>
</div>
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=EchoXMusicBot&style=flat-square" />
</p>
...
<p align="center">
  <a href="https://t.me/LoserNagiOfficial">
    <img src="https://files.catbox.moe/eh780q.jpg" width="600">
  </a>
</p>

<p align="center">
  <a href="https://t.me/EchoXMusicBot"><img src="https://img.shields.io/badge/Try%20Bot-@EchoXMusicBot-blue?style=for-the-badge&logo=telegram"/></a>
</p>


<p align="center">
  <a href="https://github.com/EchoX Network/EchoXMusic/stargazers"><img src="https://img.shields.io/github/stars/EchoX Network/EchoXMusic?style=flat-square"/></a>
  <a href="https://github.com/EchoX Network/EchoXMusic/network/members"><img src="https://img.shields.io/github/forks/EchoX Network/EchoXMusic?style=flat-square"/></a>
  <a href="https://github.com/EchoX Network/EchoXMusic/issues"><img src="https://img.shields.io/github/issues/EchoX Network/EchoXMusic?style=flat-square"/></a>
  <a href="https://github.com/EchoX Network/EchoXMusic/commits/main"><img src="https://img.shields.io/github/last-commit/EchoX Network/EchoXMusic?style=flat-square"/></a>
  <a href="https://github.com/EchoX Network/EchoXMusic/actions"><img src="https://img.shields.io/badge/CI-Status-grey?style=flat-square"/></a>
</p>

## 🌟 What is EchoXMusic?

**EchoXMusic** is a modern Telegram bot that streams **high-quality music** into group voice chats.
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          3) Get ID via <code>@EchoXMusicBot</code> or <code>@MissRose_Bot</code>
        </td>
...
# Step 3: Clone & Setup
git clone https://github.com/LoserNagiOfficial/EchoXMusic
cd EchoXMusic
tmux new -s EchoX
...
tmux attach-session -t EchoX       # Reattach session
tmux kill-session -t EchoX         # Kill bot session
rm -rf EchoXMusic                # Uninstall bot
```
...
### Step 3: Build Image
docker build -t echoxmusic .

### Step 4: Run Container
docker run -d --name echox --env-file .env --restart unless-stopped echoxmusic

### Step 5: Manage Container
docker logs -f echox        # View logs (Ctrl+C to exit)
docker stop echox           # Stop container
docker start echox          # Start again
docker rm -f echox          # Remove container
docker rmi echoxmusic      # Remove image
```
...
| 🌍 **Heroku Deploy**    | <a href="http://dashboard.heroku.com/new?template=https://github.com/EchoX Network/EchoXMusic"><img src="https://img.shields.io/badge/Deploy%20to-Heroku-purple?style=for-the-badge&logo=heroku"/></a> |
...
<p align="center">
  ...
  <a href="https://t.me/AbdulBotzOfficial">
...
* <b> *ᴄʀᴀғᴛᴇᴅ ᴡɪᴛʜ ᴘᴀssɪᴏɴ ʙʏ <a href="https://github.com/EchoX Network">ᴄᴇʀᴛɪғɪᴇᴅ ᴄᴏᴅᴇʀs</a>* </b>