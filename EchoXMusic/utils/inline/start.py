...
def owner_panel(_):
    buttons = [
        [
            InlineKeyboardButton(text=_["S_H_1"], callback_data="ahh_soon"),
            InlineKeyboardButton(text=_["S_H_2"], callback_data="ahh_soon"),
        ],
        [
            InlineKeyboardButton(text=_["S_H_3"], url=config.GITHUB),
            InlineKeyboardButton(text=_["S_H_4"], callback_data="ahh_soon"),
        ],
        [
            InlineKeyboardButton(text=_["BACK_BUTTON"], callback_data="settingsback_helper")
        ]
