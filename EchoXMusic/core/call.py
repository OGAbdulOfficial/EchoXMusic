...
from EchoXMusic.utils.formatters import check_duration, seconds_to_min, speed_converter
from EchoXMusic.utils.inline.play import stream_markup
...
class Call(PyTgCalls):
    ...
    async def join_call(
        ...
        try:
            ...
            LOGGER(__name__).error(f"PyTgCalls Exception: {e}")
    ...
    async def decorators(self):
        # Removed obsolete decorators like on_kicked, on_closed_voice_chat, on_left
        async def stream_services_handler(_, chat_id: int):
            await self.stop_stream(chat_id)

        # on_stream_end removed to prevent crash
