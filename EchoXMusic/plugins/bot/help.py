...
from EchoXMusic.utils.database import get_lang
from EchoXMusic.utils.decorators.language import LanguageStart, languageCB
from EchoXMusic.utils.inline.help import (
    help_back_markup,
    private_help_panel,
    help_pannel_page1,
    help_pannel_page2,
...
async def helper_private(
    ...
    if is_callback:
        ...
        from EchoXMusic.utils.inline.help import help_pannel_page1
...
async def help_com_group(client, message: Message, _):
    from EchoXMusic.utils.inline.help import private_help_panel
