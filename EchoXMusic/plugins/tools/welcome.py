...
from EchoXMusic.utils.database import db

try:
    wlcm = db.welcome
except:
    from EchoXMusic.utils.database import welcome as wlcm
...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open("EchoXMusic/assets/welcome.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((450, 450)) 
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('EchoXMusic/assets/font.ttf', size=45)
    font2 = ImageFont.truetype('EchoXMusic/assets/font.ttf', size=90)
...
async def greet_group(_, member: ChatMemberUpdated):
    ...
    try:
        ...
        pic = "EchoXMusic/assets/upic.png"
