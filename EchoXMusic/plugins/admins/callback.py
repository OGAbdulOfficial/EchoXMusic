...
from EchoXMusic.misc import SUDOERS, db
...
from EchoXMusic.utils.formatters import seconds_to_min
from EchoXMusic.utils.inline import close_markup, stream_markup, stream_markup_timer
from EchoXMusic.utils.inline.help import help_pannel_page1, help_pannel_page2, help_pannel_page3, help_pannel_page4
from EchoXMusic.utils.stream.autoclear import auto_clean
...
async def fork_repo_callback(client, query):
    await query.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🚀 Fᴏʀᴋ Rᴇᴘᴏ", url="https://github.com/OGAbdulOfficial/EchoXMusic/fork"),
                    InlineKeyboardButton("⚡ Hᴇʀᴏᴋᴜ Dᴇᴘʟᴏʏ", url="https://dashboard.heroku.com/new?template=https://github.com/OGAbdulOfficial/EchoXMusic")
                ],
                [
...
from EchoXMusic.utils.inline.start import about_panel
from strings import get_string
...
from pyrogram import Client, filters
from pyrogram.types import InlineKeyboardMarkup
from EchoXMusic.utils.inline.start import owner_panel  # Import owner_panel function
from strings import get_string
from config import BANNED_USERS
...
async def ahh_soon_cb(client, CallbackQuery):
    await CallbackQuery.answer('ahh soon ~', show_alert=True)
