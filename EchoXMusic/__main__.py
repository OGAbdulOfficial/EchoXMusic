...
import config
from EchoXMusic import LOGGER, app, userbot
from EchoXMusic.core.call import Nand
from EchoXMusic.misc import sudo
from EchoXMusic.plugins import ALL_MODULES
from EchoXMusic.utils.database import get_banned_users, get_gbanned
...
async def setup_bot_commands():
    try:
        ...
        LOGGER("EchoXMusic").info("Bot commands set successfully!")
...
async def init():
    ...
    for all_module in ALL_MODULES:
        importlib.import_module("EchoXMusic.plugins" + all_module)
    ...
    LOGGER("EchoXMusic").info(
        "EchoXMusic Started Successfully.\n\nDon't forget to visit @AbdulBotzOfficial"
    )
